...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lcccc@{}}
		...
		& 0.75       & 0.5        & 0.25       & 0.01       \\
		\midrule
		Difference of points           & 15646 & 350 & 197 & 9 \\
		Difference of Frechet Distance              & 0.012 & 0.012 & 0.137 & 0.084 \\
		Difference of Hausdorff Distance             & 0.012 & 0.012 & 0.137 & 0.084 \\
		Difference of DynTimeWarp Distance            & 1.045 & 3.028 & 3.732 & -10.550\\
		\bottomrule
	\end{tabular}
	\caption{Precision metrics per Lambda for Trajectory 1 }
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lcccccc@{}}
		\toprule
		& \multicolumn{5}{c}{\textbf{Douglas}} \\
		\cmidrule(l){2-6}
		\textbf{SquishE} & 5 & 2 & 0.02 & 0.002 & 0.0002 \\
		\midrule
		\textbf{1x} & 0 & 0 & 0 & 0 & 0 \\
		Frechet & 0 & 0 & 0 & 0 & 0 \\
		Hausdorff & 0 & 0 & 0 & 0 & 0 \\
		DTW & 0 & 0 & 0 & 0 & 0 \\ \midrule
		\textbf{2x} & 0 & 0 & 0 & 0 & 0 \\
		Frechet & 0 & 0 & 0 & 0 & 0 \\
		Hausdorff & 0 & 0 & 0 & 0 & 0 \\
		DTW & 0 & 0 & 0 & 0 & 0 \\ \midrule
		...
		\bottomrule
	\end{tabular}
	\caption{Comparaison des différences entre Douglas et SquishE (Frechet, Hausdorff, DTW)}
\end{table}
