...
class Window(Tk):
    ...
    def add_point(self,event):
        ...
        self.canvas.create_line([(elem[0],elem[1]) for elem in self.path] ,fill="gray", width=3 )
    ...
    def simplify_path(self,event):
        ...
        self.canvas.delete("all")
        self.canvas.create_line([(elem[0],elem[1]) for elem in self.path] ,fill="gray", width=3 )
        self.canvas.create_line([(elem[0],elem[1]) for elem in self.simple] ,fill="red", width=3 )
